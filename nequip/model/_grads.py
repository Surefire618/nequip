...
from nequip.nn import StrainStressOutput as StrainStressOutputModule
...
def StrainStressOutput(model: GraphModuleMixin) -> GradientOutput:
    r"""Add forces and stresses to a model that predicts energy.
    ...
    if (
        ...
        raise ValueError("This model already has force or stress outputs.")
    return StrainStressOutputModule(func=model)
